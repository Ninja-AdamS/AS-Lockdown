...
namespace UFPPC
{
    ...
    public class UniversalFirstPersonPlayerController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            float speed = Input.GetKey(sprintButton) ? walkSpeed : runSpeed;
            ...
            if (drankPop){
                characterController.Move((12/ crouchSpeedDivision) * Time.deltaTime * moveDir);
